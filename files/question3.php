...
foreach ($file_lines as $key => $line) {
    ...
    $user = "INSERT INTO tuser (id_number, first_name, last_name) 
    			VALUES ('"{$data[$userTableColumnsIndexes['id_number']]}"', 
    				'"{$data[$userTableColumnsIndexes['first_name']]}"', '"{$data[$userTableColumnsIndexes['last_name']]}"')";
